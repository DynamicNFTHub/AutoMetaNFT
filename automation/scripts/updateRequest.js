...
const subscriptionId = 666; // REPLACE this with your subscription ID

const updateRequestMumbai = async () => {
  // hardcoded for Polygon Mumbai
  const routerAddress = "0x6E2dc0F9DB014aE19888F539E59285D2Ea04244C"; // Router for Mumbai
  ...
  const secrets = { authKey: process.env.WEB_SERVER_AUTHENTICATION_KEY };
